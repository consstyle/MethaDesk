            ...
            <div className="flex justify-between items-center gap-4">
                ...
                <div className="flex gap-2">
                    <Button
                        ...
                        onClick={() => {
                            if (confirm('Möchten Sie alle lokalen Daten löschen und die Beispieldaten aus der Bildquelle neu laden?')) {
                                mockStore.resetData();
                            }
                        }}
                    >
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            if (confirm(`Sind Sie sicher, dass Sie "${item.name}" löschen möchten?`)) {
                                                                const currentItems = mockStore.getTeilsysteme(projektId);
                                                                const newItems = currentItems.filter((i: Teilsystem) => i.id !== item.id);
                                                                mockStore.saveTeilsysteme(newItems);
