    ...
    return (
        <div className="min-h-screen bg-background transition-colors">
            ...
            <div className="flex pt-16">
                {projektId && <Sidebar projektId={projektId} />}
            ...
            {projektId && (
                <div className={cn(
                    "fixed inset-y-0 left-0 z-50 w-64 bg-sidebar shadow-2xl transition-transform duration-300 lg:hidden border-r",
